...
// ✅ Use your real AppNavigator (with bottom tabs + CustomerListScreen)
  ...
  return (
    <SafeAreaProvider>
      <AuthProvider>
        <LanguageProvider>
          <NavigationContainer>
            {/* AppNavigator handles Welcome/Login/Signup + Bottom Tabs (Home, Customers, Orders, Analytics, Profile) */}
